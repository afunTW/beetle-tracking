...
EXPECT_DETECT_OUTPUT="$VIDEO_DIRNAME/$VIDEO_NAME"_detection.txt
EXPECT_CLASS_OUTPUT="$VIDEO_DIRNAME/$VIDEO_NAME"_ensemble.txt
EXPECT_MOUSE_OUTPUT="$VIDEO_DIRNAME/$VIDEO_NAME"_mouse.json
EXPECT_PATHS_OUTPUT="output/path/$VIDEO_NAME/paths.csv"
